...
class DefaultLayout(jp.QLayout):
    """Пользовательский макет для веб-приложения с использованием инфраструктуры JustPy"""

    def __init__(self, view="hHh lpR fFf", **kwargs):   # view - формат представления макета
        super().__init__(view=view, **kwargs)   # super represent parent
